...
This is a section of blockchain course by Freecodecamp. The project shows how the defi system works.

Perticularly aave protocol is used here to show the process of depositing collateral, borrowing to repaying the assets back. 
